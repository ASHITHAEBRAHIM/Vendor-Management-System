...
from vendor_app.views import VendorViewSet,VendorPerformanceViewSet,PurchaseOrderViewSet,CreateUserView
...
urlpatterns = [
    ...
    path('api/purchase_orders/<int:pk>/acknowledge/', PurchaseOrderViewSet.as_view({'post': 'acknowledge'}), name='purchaseorder-acknowledge'),
